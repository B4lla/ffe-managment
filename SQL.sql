...
CREATE TABLE empresas (
    ...
    dni_cif VARCHAR(512) UNIQUE NOT NULL,
    actividad TEXT,
    categoria ENUM('ayuntamiento', 'colegios_institutos', 'empresas') NULL,
...
CREATE TABLE convenios (
    ...
    resp_gestion_nombre VARCHAR(512),
    resp_gestion_telefono VARCHAR(512),
    resp_gestion_email VARCHAR(512),
    resp_ies_nombre VARCHAR(512),
    resp_ies_telefono VARCHAR(512),
    resp_ies_email VARCHAR(512),
    fecha_firma DATE,
