...
CREATE TABLE empresas (
    ...
    dni_cif VARCHAR(512) NOT NULL,
    dni_cif_hash CHAR(64) NOT NULL UNIQUE,
    actividad TEXT,
    categoria ENUM('ayuntamiento', 'colegios_institutos', 'empresa') NULL,
    tipo ENUM('verde', 'amarilla', 'roja') NULL,
    email VARCHAR(512),
    email_hash CHAR(64) NULL,
    telefono1 VARCHAR(512),
    telefono1_hash CHAR(64) NULL,
    telefono2 VARCHAR(512),
    telefono2_hash CHAR(64) NULL,
    provincia VARCHAR(512),
    municipio VARCHAR(512),
    direccion TEXT,
    codigo_postal VARCHAR(512),
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    INDEX idx_empresas_email_hash (email_hash),
    INDEX idx_empresas_telefono1_hash (telefono1_hash),
    INDEX idx_empresas_telefono2_hash (telefono2_hash)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE representantes (
    ...
    nif VARCHAR(512),
    nombre VARCHAR(512),
    apellido1 VARCHAR(512),
    apellido2 VARCHAR(512),
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    FOREIGN KEY (empresa_id) REFERENCES empresas(id) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE convenios (
    ...
    resp_gestion_nombre TEXT,
    resp_gestion_telefono TEXT,
    resp_gestion_email TEXT,
    resp_ies_nombre TEXT,
    resp_ies_telefono TEXT,
    resp_ies_email TEXT,
    fecha_firma DATE,
