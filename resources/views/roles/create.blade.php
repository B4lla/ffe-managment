            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                ...
                <form method="POST" action="{{ route('roles.store') }}">
                    ...
                    <div>
                        ...
                        <input name="nombre" type="text" value="{{ old('nombre') }}" required class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
                    </div>
                    ...
                    <div class="flex justify-end gap-3 mt-4">
                        ...
                        <button type="submit" class="inline-flex items-center px-4 py-2 bg-indigo-600 text-black rounded-md hover:bg-indigo-700">Crear</button>
                    </div>
                </form>
            </div>
        </div>
